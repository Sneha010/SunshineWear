...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void sendDataToWear(double high, double low , Bitmap largeIcon) {
        ...
        Asset asset = toAsset(Bitmap.createScaledBitmap(largeIcon, 70, 70, true));

        PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(Constants.WEATHER_PATH);
        putDataMapRequest.getDataMap().putString(Constants.HIGH_TEMP_KEY, Utility.formatTemperature(context, high));
        putDataMapRequest.getDataMap().putString(Constants.LOW_TEMP_KEY, Utility.formatTemperature(context, low));
        putDataMapRequest.getDataMap().putAsset(Constants.WEATHER_CONDITIONS_ICON_KEY, asset);
